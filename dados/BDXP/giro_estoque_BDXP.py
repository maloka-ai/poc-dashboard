...
try:
    ...
    if len(inconsistencias) > 0:
        ...
        caminho_inconsistencias = os.path.join(os.path.dirname(os.path.abspath(__file__)), "analise_consistencia_estoque.csv")
        analise_consistencia.to_csv(caminho_inconsistencias, index=False)
